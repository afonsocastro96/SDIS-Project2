...
public class Peer implements BackupService {
    ...
    public static void main(String [] args){
        ...
        if (! (MIN_ARGS <= args.length && args.length <= MAX_ARGS) ) {
            System.out.println("Usage: communication.Peer <id> <mc_addr> <mc_port> <mdb_addr> <mdb_port> <mdr_addr> <mdr_port> [ENH]");
            return;
        }
        ...
        try {
            ...
            System.out.println("Failed to start communication.Peer");
        }
    }
