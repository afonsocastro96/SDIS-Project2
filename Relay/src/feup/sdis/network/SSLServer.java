...
public class SSLServer implements Runnable, Observer {
    ...
    public SSLServer(final String host, final int port) {
        ...
        this.listeners = Arrays.asList(new GetChunkListener(), new PutChunkListener(), new FileNameListener(), new WhoAmIListener(), new RestoreListener(), new DeleteListener(), new HasChunkListener());
        this.host = host;
        this.port = port;
