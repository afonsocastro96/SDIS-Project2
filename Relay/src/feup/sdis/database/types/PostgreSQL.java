...
public class PostgreSQL extends Database {
     ...
     * @param schema   schema of the PostgreSQL
     * @param username username of the PostgreSQL
     * @param password password of the PostgreSQL
     */
    public PostgreSQL(final String hostname, final int port, final String database, final String schema, final String username, final String password) {
        super("org.postgresql.Driver", "jdbc:postgresql://" + hostname + ":" + port + "/" + database + "?currentSchema=" + schema, username, password);
    }
}